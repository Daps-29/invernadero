...
if (!empty($_POST))
{
  if(empty($_POST['temperatura']) || empty($_POST['tiempoCosecha']) || empty($_POST['humedad']) )
{
  $alert='<p class="msg_error">EL CAMPO, TIEMPO DE COSECHA ES OBLIGATORIO.</p>';
} else {
    ...
    $ides = $_POST['ides'];
      ...
      $quey_insert = mysqli_query($conexion,"INSERT INTO registro_produccion(usuario_id,idinvernadero,tiempoCosecha,temperatura,humedad,cantidad,descripcion,espacio,textColor)
        VALUES('$idusuario','$idinvernadero','$tiempoCosecha','$temperatura','$humedad','0','Frutillas en germinación','$ides','#FFFFFF') ");
      if ($quey_insert) {
          $update = mysqli_query($conexion, "UPDATE registro_produccion r INNER JOIN espacios e ON r.espacio = e.ides SET e.disponible = '0' WHERE e.ides = '$ides'");
           ...
           <form method="POST">
              ...
              <option value="<?php echo $rol["idinvernadero"]; ?>"><?php echo $rol["nombre"] ?></option>
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="number" class="form-control" name="temperatura" id="temperatura" maxlength="256" value="18" readonly>
                          </div>

                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Humedad:</label>
                            <input type="number" class="form-control" name="humedad" id="humedad" value="45" readonly >
                          </div>
                          ...
                          <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <a href="frutilla.php"><button class="btn btn-danger"type="button"> Cancelar</button></a>
                          </div>
                        </form>
